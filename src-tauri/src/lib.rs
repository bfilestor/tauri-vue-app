...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::member::list_family_members,
            commands::member::create_family_member,
            commands::member::update_family_member,
            commands::member::delete_family_member,
            commands::member::set_default_family_member,
